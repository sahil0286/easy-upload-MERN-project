...
export const Steps = () => {
  ...
  <div style={{height:"300px"}}>
    ...
    <div className="container my-100 px-4">
    ...
    <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div className="col d-flex align-items-start">
        ...
        <div>
          <h4>Step 3: Copy Link for Share/Download</h4>
          <ul>
            <li>Click on the "Copy" button to copy the generated link to the clipboard.</li>
            <li>You can now paste the link into emails, messages to share or download the uploaded file. 🚀</li>
          </ul>
        </div>
      </div>
    </div>
